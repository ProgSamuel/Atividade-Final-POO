...
/// Create Users
const user1 = new User('Sam', 'sam@example.com', 'password1')
const user2 = new User('Alice', 'alice@example.com', 'password2')
const user3 = new User('Bob', 'bob@example.com', 'password3')
...
// Show Tweets
console.log('Sam\'s Tweets:', user1.showTweets())
